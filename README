...
║ Table of Contents                                                            ║
╟──────────────────────────────────────────────────────────────────────────────╢
║ README.md: This file, basics on running the program                          ║
║ BUILD.md:  Information on how to compile and install the program. Information║
║            on how to modify the program to run under different conditions or ║
║            with different sonar units.                                       ║
║ RUN.md:    Information on command line options for running the program.      ║
